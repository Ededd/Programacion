pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~prueb.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~prueb.adb");
with Ada.Exceptions;
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_prueba_posicion_valor_ultimo_capicua_de_n_digitos");
