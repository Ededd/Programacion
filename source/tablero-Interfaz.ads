...
package Tablero.Interfaz is
   ...
   --          número positivo con la dificultad del sudoku
   -- Efecto: Inicializa la interfaz gráfica con los valores dados
   ...
   -- Entrada: Cantidad_Errores, numero de val ores mal colocados
