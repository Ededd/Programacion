...
--     constant Natural := Indices_de_Nueve.Num_columnas * 26 +
   constant Natural := Indices.Num_columnas * 33+
     Espacio_Entre_Areas * 2;
   Altura_Tablero_Casillas :
--     constant Natural := 40 + (Indices_de_Nueve.Num_Filas * 26) +
...
--        GWindows.Drawing.Put (Canvas, 370, 95, "Hay inconsistencias");
--        Gwindows.Drawing.Put (Canvas, 370, 115, "en las zonas");
--        GWindows.Drawing.Put (Canvas, 370, 135, "marcadas en rojo ");
